...
namespace clefia {
    inline void ByteCpy(unsigned char *dst, const unsigned char *src, int bytelen);

    inline void ByteXor(unsigned char *dst, const unsigned char *a, const unsigned char *b, int bytelen);

    inline void BytePut(const unsigned char *data, int bytelen);

    inline unsigned char ClefiaMul2(unsigned char x);

    inline void ClefiaF0Xor(unsigned char *y, const unsigned char *x, const unsigned char *rk);

    inline void ClefiaF1Xor(unsigned char *y, const unsigned char *x, const unsigned char *rk);

    inline void ClefiaGfn4(unsigned char *y, const unsigned char *x, const unsigned char *rk, int r);

    inline void ClefiaGfn8(unsigned char *y, const unsigned char *x, const unsigned char *rk, int r);

    inline void ClefiaGfn4Inv(unsigned char *y, const unsigned char *x, const unsigned char *rk, int r);

    inline void ClefiaDoubleSwap(unsigned char *lk);

    inline void ClefiaConSet(unsigned char *con, const unsigned char *iv, int lk);

    inline void ClefiaKeySet128(unsigned char *rk, const unsigned char *skey);

    inline void ClefiaKeySet192(unsigned char *rk, const unsigned char *skey);

    inline void ClefiaKeySet256(unsigned char *rk, const unsigned char *skey);

    inline int ClefiaKeySet(unsigned char *rk, const unsigned char *skey, const int key_bitlen);

    inline void ClefiaEncrypt(unsigned char *ct, const unsigned char *pt, const unsigned char *rk, const int r);

    inline void ClefiaDecrypt(unsigned char *pt, const unsigned char *ct, const unsigned char *rk, const int r);
//////////////new here
